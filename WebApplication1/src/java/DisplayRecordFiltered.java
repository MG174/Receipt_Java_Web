 ...
 * @author goryc
 */
@WebServlet(urlPatterns = {"/DisplayRecordFiltered"})
public class DisplayRecordFiltered extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DisplayImageFiltered</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DisplayImageFiltered at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//out.println("<script>");
////out.println("var param = $('#clickedId').val();");
////out.println("            $(document).on(\"click\", \"#somebutton\", function() { ");
////out.println("var fired_button = $(this).val();");
////out.println("                $.get(\"someservlet\", function(responseText) {   ");
////out.println("                    $(\"#somediv\").text(responseText);    ");
////out.println("                });");
////out.println("            });");
//out.println("$(\"#somebutton\").click(function() {");
//out.println(".ajax({");
//out.println("   url:\"/someservlet\",");
//out.println("   data: {id:$(\"#somebutton\").val()}");
//out.println(")");
//out.println(".done(function(response) {");
//out.println("   $(\"#somediv\").text(responseText);");
//out.println("});");
//out.println(");");
//out.println("        </script>");
            out.println("</head>");
            out.println("</br>");
            out.println("<a href=\"DisplayImageExpand\"><button type=\"submit\">Expand Images</button></a>");
            out.println("</br>");
            ...
            out.println("</br>");
            out.println("<form class=\"form-inline\" action=\"./DisplayRecordFiltered\" method=\"post\">");
            out.println("  <div class=\"form-group\">");
            out.println("    <label for=\"exampleInputAmount\">Price from: </label>");
            out.println("    <input type=\"text\" name=\"price_from\" class=\"form-control\" id=\"exampleInputAmount\" placeholder=\"15\">");
            out.println("  </div>");
            out.println("  <div class=\"form-group\">");
            out.println("    <label for=\"exampleInputAmount\">Price to: </label>");
            out.println("    <input type=\"text\" name=\"price_to\" class=\"form-control\" id=\"exampleInputAmount\" placeholder=\"15\">");
            out.println("  </div>");
            out.println("  <div class=\"form-group\">");
            ...
            out.println("    <input type=\"text\" name=\"category\" class=\"form-control\" id=\"exampleInputName2\" placeholder=\"food\">");
            out.println("  </div>");
            out.println("  <button type=\"submit\" class=\"btn btn-default\">Filter</button>");
            out.println("</form>");
//            out.println("</br>");
...
//                out.println("<form action=\"./DisplayImage\" method=\"post\" class=\"buttonintable\">");
//                out.println("<input type=\"hidden\" name=\"bt\" value=" + idr + ">");
//                out.println("<input type=\"submit\" value=\"Display Photo\"/>");
//                out.println("</form>");
//out.println("<form>");
//out.println("<input type=\"hidden\" name=\"clicked_button\" value=" + idr + " id=\"clickedId\" />");
//out.println("<button type=\"button\" id=\"somebutton\" value=" + idr + " class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#myModal\">");
//out.println("  Launch demo modal");
//out.println("</button>");
//out.println("</form>");
//out.println("");
...
//out.println("        <h4 class=\"modal-title\" id=\"myModalLabel\">Modal title</h4>");
//out.println("      </div>");
////out.println("<img src=\"data:image/jpg;base64," + base64Image + "\" width=\"400\" height=\"300\" />");
//out.println("      <div id=\"somediv\"></div>");
//out.println("      </div>");
//out.println("      <div class=\"modal-footer\">");
//out.println("        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>");
//out.println("        <button type=\"button\" class=\"btn btn-primary\">Save changes</button>");
//out.println("      </div>");
//out.println("    </div>");
//out.println("  </div>");
//out.println("</div>");
...
//out.println("</div>");
//out.println("<img src=\"data:image/jpg;base64," + base64Image + "\" width=\"400\" height=\"300\" />");
                out.println("<button class=\"openmodal myBtn\">Show image</button>");
                out.println("");
                out.println("<!-- The Modal -->");
                out.println(" <div class=\"modal myModal\">");
                out.println("");
                out.println("  <!-- Modal content -->");
                out.println("  <div class=\"modal-content\">");
                out.println("  <span class=\"close\">&times;</span>");
                out.println("<img src=\"data:image/jpg;base64," + base64Image + "\" width=\"500\" height=\"500\" />");
                out.println("  </div>");
                out.println("</div>");
...
//out.println("<script src=\"/WebApplication1/js/imagemodal.js\"></script>");
                ...
                out.println("<form action=\"./EditRecord\" method=\"post\" class=\"buttonintable\" >");
                out.println("<input type=\"hidden\" name=\"bt\" value=" + idr + ">");
...
//                out.println("<form action=\"./deleteRecord.jsp\" method=\"post\" class=\"buttonintable\">");
//                out.println("<input type=\"hidden\" name=\"bt\" value=" + idr + ">");
