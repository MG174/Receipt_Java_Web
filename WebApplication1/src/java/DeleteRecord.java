...
public class DeleteRecord extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String id_record = request.getParameter("bt");
            

            PreparedStatement st = con.prepareStatement("delete from receipt where id_receipt=?");
            st.setString(1, id_record);
...
out.println("            <h1 class=\"text-center\">Successfully deleted record</h1>");
